...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a href="signin.php">
            <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><a href="signout.php">Sign out</a></button>
        </a>
    </nav>
    <div class="container-fluid">
        <ul class="nav nav-pills nav-fill">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="done.php">Done</a>
            </li>
        ...
        <?php
                ...
                while($row=mysqli_fetch_assoc($result)){
                    if($row['current_status']==1 && $row['user_id']==$user_id){
